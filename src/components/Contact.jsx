  ...
  return (
    <div>
      <section class="text-gray-600 body-font">
        <div class="container px-5 pt-2 mx-auto space-x-4">
          <div class="flex flex-wrap -mx-4 -my-2">
            <div class="py-8 px-4 lg:w-1/3">
              <div class="h-full flex items-start">
                <div class="flex-grow pl-6">
                  <h1
                    class="title-font text-3xl font-medium justify-start text-left text-[#292662] mb-3"
            ...
            <div class="py-2 px-4 -mt-5 md:mt-20 mb-6 lg:w-1/3">
